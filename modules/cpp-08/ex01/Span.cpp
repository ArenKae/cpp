...
/*   Updated: 2024/11/12 20:17:23 by acosi            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// Copy constructor
Span::Span(const Span &src) : lst(src.lst), _size(src._size)
{
...
void Span::addNumber(int num)
{
	...
	<< YELLOW << lst.size()  << "/" << _size << RESET << std::endl;
}
...
int Span::shortestSpan() const
{
	...
	// Create a copy of lst and sort it in ascending order
...
int Span::longestSpan() const
{
	...
	int min_element = *std::min_element(lst.begin(), lst.end());
